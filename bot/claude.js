...
export async function analyzePost(notes, { post, matches, kolRow, priceData }) {
  ...
  const parts = [
    ...
    "4. PRICE REALITY-CHECK — compare the claim against the DEX data below: is the post early, late, or narrating a move that already happened? Note fresh pairs and thin liquidity.",
