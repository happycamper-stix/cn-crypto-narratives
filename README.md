---
title: CN Crypto Narratives
tags: [cn-crypto-narratives, index]
created: 2026-08-21
updated: 2026-08-21
status: active
type: permanent
...
# CN Crypto Narratives

Living glossary decoding Chinese crypto lingo, sayings, coin names, and tickers into
English — capturing what the term *actually means* (wordplay, homophones, memes,
cultural context), not the literal translation.

## Structure
- `patterns/` — the generative mechanics: how the slang gets made
- `glossary/` — term tables by category + atomic notes for rich etymologies
- `narratives/` — meta-narratives, eras, and ecosystems the lingo lives in
- `references/` — sources, live feeds, KOL directory, methodology
- `logs/` — session logs
...
- [[pinyin-initialisms]] — YYDS, NSDD, U1S1
- [[martial-military-metaphors]] — armies, ambushes, the 打-verb family
- [[kinship-family-metaphors]] — 亲属称谓: 大饼 patriarch, 太子/姨太, 孙哥→孙割, 家人们
- [[gambling-film-register]] — 梭哈 and the HK God-of-Gamblers register
- [[classical-literary-register]] — 铭文/符文: Ordinals as bronze inscriptions
- [[reduplication-cuteness]] — 狗狗币, 索拉拉, 冲冲冲
- [[irony-cope-register]] — 图一乐, ironic 价值投资, 信仰
- [[transliteration-mechanics]] — 音译 vs 意译; nickname choice as sentiment index
- [[code-switching-mechanics]] — 中英夹杂: 被rug了, gas费, mint一下; the hybrid grammar layer
- [[name-taboo-anonymization]] — 某安/孙某/VX: the deliberate not-naming system
...
- [[inscription-mania]] — why BRC-20 was a Chinese-retail narrative
- [[launchpad-naming-meta]] — the 2024–26 中文 meme season naming conventions
- [[meme-season-aftermath]] — 10·11 crash, Jan 2026 second wave (?), current state
- [[binance-gravity-well]] — CZ/一姐 as narrative oracle
- [[kol-shilling-ecosystem]] — 喊单, 带单老师, the KOL轮
- [[patriotic-coin-narratives]] — 国产币 pride vs 传销币 nationalism scripts
- [[hk-tw-mainland-divergence]] — regulatory and terminology accents
- [[lumao-industrial-complex]] — airdrop studios and the 反女巫 arms race
- [[pig-butchering-dark-lexicon]] — how scam-compound argot fed the mainstream

## References
- [[sources]] — full reading list
- [[archived-glossaries]] — recovered Quartz/Xuehua term lists
- [[live-feeds]] — where to watch narratives form in real time
- [[cn-ct-kol-directory]] — famous Chinese CT accounts, by tier
- [[research-methodology]] — playbook for adding/verifying terms

## Glossary note format
Each term note carries: Chinese characters, pinyin, literal translation, actual
meaning, origin/wordplay mechanics, example usage, and wikilinks to related terms
and the pattern that generates it.
